...
for i in glob.glob(
    ...
    "../../../JARVIS-ALIGNN/Models/17005774/*.zip"
    ...
    if "supercon" not in i:
        ...
        if p in pp:
            model_zipfile = (
                ...
                "../../../JARVIS-ALIGNN/Models/17005774/mp_"
                #"../../../JARVIS-ALIGNN/Models/17005987/hmof_"
                #"../../../JARVIS-ALIGNN/Models/17005681/dft_3d_"
                + p
                #+ "_alignn.zip"
                + "_alignnn.zip"
            )
            ...
            temp = "mp_" + p + "_alignnn/ids_train_val_test.json"
            ...
            temp = "mp_" + p + "_alignnn/prediction_results_test_set.csv"
            ...
            fname = "SinglePropertyPrediction-test-" + p + "-mp-AI-mae.csv"
