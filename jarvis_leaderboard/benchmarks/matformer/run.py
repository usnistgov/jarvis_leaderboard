...
for i in props:
   ...
   if not os.path.exists(csv_path):
        t1=time.time()
        train_prop_model(learning_rate=0.001,name="matformer", prop=props[0], pyg_input=True, n_epochs=50, batch_size=64, use_lattice=True, output_dir=output_dir, use_angle=False, save_dataloader=False)
        t2=time.time()
