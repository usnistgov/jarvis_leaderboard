...
train = SinglePointLmdbDataset(
    {"src": "/wrk/knc6/oc/ocp/data/is2re/10k/train/data.lmdb"}
)
...
my_dir='/wrk/knc6/Software/alignn_calc/jarvis_leaderboard/jarvis_leaderboard/contributions/alignn_model/ocp10k/'
...
m['val']=xval
m['test']=xtest
dumpjson(data=mem,filename='ocp10k.json')
dumpjson(data=m,filename='ocp10k_relaxed_energy.json')
f.close()
