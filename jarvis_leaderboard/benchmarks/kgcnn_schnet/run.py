#https://colab.research.google.com/github/knc6/jarvis-tools-notebooks/blob/master/jarvis-tools-notebooks/kgcnn_jarvis_leaderboard.ipynb#scrollTo=SNkSXv5sPNV5
...
df_test = df[-n_test:]
f=open('AI-SinglePropertyPrediction-exfoliation_energy-dft_3d-test-mae','w')
