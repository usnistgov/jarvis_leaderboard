...
for task in tasks:
    ...
    if not os.path.exists(zip_name):
        ...
        def prepare_data(dirname="exfoliation_en", populated_data_path="Out"):
            ...
            dataset.map_list(
                method="set_range_periodic", max_distance=5.0, max_neighbours=None
            )
        ...
        model.fit(
            ...
            callbacks=[
                ...
                LinearLearningRateScheduler(epo_min=8, epo=800, learning_rate_start=5e-04, learning_rate_stop=1e-05)
            ],
