...
def setup_calculator(calculator_type):
    if calculator_type == "matgl":
        ...
        model_path="/users/dtw2/utils/models/alexandria_v2/mace/2D_universal_force_field_cpu.model" #adjust path to mace-alexandria
        return MACECalculator(model_path,device="cpu") 
    elif calculator_type == "sevennet":
        from sevenn.sevennet_calculator import SevenNetCalculator
        checkpoint_path = "/users/dtw2/SevenNet/pretrained_potentials/SevenNet_0__11July2024/checkpoint_sevennet_0.pth" #adjust path to sevennet
        ...
        return OCPCalculator(checkpoint_path="/users/dtw2/fairchem-models/pretrained_models/eqV2_31M_omat.pt") #adjust path to OMat24
    elif calculator_type == "eqV2_86M_omat":
        from fairchem.core import OCPCalculator
        return OCPCalculator(checkpoint_path="/users/dtw2/fairchem-models/pretrained_models/eqV2_86M_omat.pt") #adjust path to OMat24   
    elif calculator_type == "eqV2_153M_omat":
        from fairchem.core import OCPCalculator
        return OCPCalculator(checkpoint_path="/users/dtw2/fairchem-models/pretrained_models/eqV2_153M_omat.pt") #adjust path to OMat24
    elif calculator_type == "eqV2_31M_omat_mp_salex":
        from fairchem.core import OCPCalculator
        return OCPCalculator(checkpoint_path="/users/dtw2/fairchem-models/pretrained_models/eqV2_31M_omat_mp_salex.pt") #adjust path to OMat24
    elif calculator_type == "eqV2_86M_omat_mp_salex":
        from fairchem.core import OCPCalculator
        return OCPCalculator(checkpoint_path="/users/dtw2/fairchem-models/pretrained_models/eqV2_86M_omat_mp_salex.pt") #adjust path to OMat24
    else:
...
class MLearnForcesAnalyzer:
    def __init__(self, calculator_type, mlearn_elements, output_dir=None):
        self.calculator_type = calculator_type
