...
#wget https://dl.fbaipublicfiles.com/opencatalystproject/models/2021_02/is2re/cgcnn_10k.pt
dat = get_request_data(js_tag="ocp10k.json",url="https://figshare.com/ndownloader/files/40566122")
df = pd.DataFrame(dat)
path = "/wrk/knc6/Software/alignn_calc/jarvis_leaderboard/jarvis_leaderboard/benchmarks/AI/SinglePropertyPrediction/ocp10k_relaxed_energy.json.zip"
...
attrs = torch.load("cgcnn_10k.pt", map_location=device)["config"][
    "model_attributes"
]
print("attrs", attrs)
model = CGCNN(
...
model.load_state_dict(
    torch.load("cgcnn_10k.pt", map_location=device)["state_dict"]
)
model.to(device)
model.eval()
