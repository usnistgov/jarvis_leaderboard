...
import os
t1=time.time()
sk_class(   csv_path='/wrk/knc6/AtomNLP/Summarize/cond_mat.csv',key='categories',value='abstract')
t2=time.time()
print ('Time',t2-t1)
...
t1=time.time()
sk_class(   csv_path='/wrk/knc6/AtomNLP/Summarize/pubchem.csv',key='label_name',value='abstract')
t2=time.time()
print ('Time',t2-t1)
